                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:statusInstance, field:'message')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:statusInstance, field:'dateCreated')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="person" action="show" id="${statusInstance?.person?.id}">${statusInstance?.person?.encodeAsHTML()}</g:link></td>
